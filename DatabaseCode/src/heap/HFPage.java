...
public class HFPage extends Page 
  ...
  */
  ...
  /**
   * a byte array of size[MAX_SPACE]
   */
  // private byte [] data;
 ...
 * @throws IOException 
  ...
  public HFPage () throws IOException   { 
	  setFreeSpace();	  
  }
  ...
  public RID insertRecord ( byte [] record)		
	...
	return   rid ;*/
	  ...
	  //Old code wasn't inserting the correct data
	  
	  RID rid = null;
      short len = (short)record.length;
     
      if (isFull( len ) )  //enough space for record
      {
              ...
              updateDir( getSlotCnt(), writeLocation );
  ...
  private void updateDir( int sNumber, short value) throws java.io.IOException
  {
          Convert.setShortValue( value, ( ( sNumber * USED_PTR) + DPFIXED), data);
  }
  ...
  public Tuple returnRecord ( RID rid )
	  ...
	  && (pageNo.pid == curPage.pid))
	{
	  ...
	  //But the new code dosen't work either
	  Tuple retValue = null;
...
public int recordCount() throws IOException {
	...
	if( getSlotCnt() > 0 )
	{
        ...
        {
        		if (0 <= i && i < getSlotCnt())
        			value = Convert.getShortValue( ( i * USED_PTR ) + DPFIXED, data);
...
private boolean slotIsDeleted(short value) {
	// TODO Auto-generated method stub
	return false;
}

private short getSlotDirValue(int i) {
	// TODO Auto-generated method stub
	return 0;
}
...
/**
 * This is just a wrapper function for setFreeSpace with an arugment
 * Its good when you want to set up a defualt free space
 * @throws IOException
 */
public void setFreeSpace() throws IOException {
	// TODO Auto-generated method stub
	setFreeSpace( (short)( MAX_SPACE - DPFIXED ) );
}

private void setFreeSpace( short s ) throws IOException {
	// TODO Auto-generated method stub
	Convert.setShortValue( s, FREE_SPACE, data);
}

public boolean isFull(int recordLength) throws IOException {
	// TODO Auto-generated method stub
	return ( available_space() >= ( recordLength + this.USED_PTR));
}
